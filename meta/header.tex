...
\documentclass[DIV=12, a4paper, fontsize=10pt,footinclude,headinclude,plainfootsepline]{scrartcl}
...
% use fullpage and no margins
%\usepackage[headings]{fullpage} % zu wenig rand
\usepackage[
%showframe
